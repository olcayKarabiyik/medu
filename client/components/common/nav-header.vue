<template lang='pug'>
  v-app-bar.nav-header(color='gray', dark, app, :clipped-left='!$vuetify.rtl', :clipped-right='$vuetify.rtl', fixed, flat, :extended='searchIsShown && $vuetify.breakpoint.smAndDown')
    ...
    v-layout(row)
      v-flex(xs5, md4)
        v-toolbar.nav-header-inner(color='gray', dark, flat, :class='$vuetify.rtl ? `pr-3` : `pl-3`')
      ...
      v-flex(md4, v-if='$vuetify.breakpoint.mdAndUp')
        v-toolbar.nav-header-inner(color='gray', dark, flat)
          slot(name='mid')
      ...
      v-flex(xs7, md4)
        v-toolbar.nav-header-inner.pr-4(color='gray', dark, flat)
          v-spacer
